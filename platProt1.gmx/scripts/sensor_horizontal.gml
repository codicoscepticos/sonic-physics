//**/moola = "no"//
//if (speedY < 0 and not onGround and (lastYonGround - y) < (tileHeightDoubled - pointHeight)) exit// and not onGround and (lastYonGround - y) < (tileHeightDoubled - pointHeight)
